...
@Component({
  selector: 'app-statisticsMod',
  templateUrl: './statisticsMod.component.html',
  styleUrls: ['./statisticsMod.component.css']
})
export class StatisticsModComponent implements OnInit {
